...
namespace HotelBookingsWeb.Migrations
{
    ...
    [Migration("20221011213953_SetPropertyInBooking")]
    partial class SetPropertyInBooking
    {
            ...
            modelBuilder.Entity("HotelBookingsWeb.Model.Reservation", b =>
                {
                    ...
                    b.HasOne("HotelBookingsWeb.Model.HotelInfo", null)
                        .WithMany("Bookings")
                        .HasForeignKey("HotelInfoId");

                    b.HasOne("HotelBookingsWeb.Model.Property", "Property")
                        .WithMany("Bookings")
